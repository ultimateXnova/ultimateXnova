...
$LNG['intro_welcome']			= 'Herzlich Willkommen bei ultimateXnova!';
$LNG['intro_text']				= 'Dieses Spiel basiert auf SteemNova, einer Weiterentwicklung von 2Moons, welche auf XNova basiert.<br><br>Das Installations-System führt Sie durch die Installation, oder Upgrade auf einer vorherigen Version auf die neueste ein. Jede Frage, ein Problem zögern Sie bitte nicht, unsere Entwicklung und Unterstützung zu ersuchen.<br><br>ultimateXnova ist ein OpenSource-Projekt und ist under GNU GPL v3 lizenziert. Zur Lizenz klicken Sie bitte im Menu auf die entsprechenden Menüpunkt.<br><br>Bevor die Installation gestartet werden kann, wird vorher ein kleiner Test durchgeführt, ob sie die Mindestanforderungen unterstützen.';
$LNG['intro_upgrade_head']		= 'ultimateXnova schon installiert?';
$LNG['intro_upgrade_text']		= '<p>Du hast das Spiel bereits installiert und möchtest einfach updaten?</p><p>Hier kann du deine alte Datenbank mit wenigen klicks aktualisieren!</p>';
...
$LNG['upgrade_required_rev']	= 'Der Updater kann nur ab Revision r2579 (ultimateXnova v1.7) oder höher updaten.';
...
$LNG['req_php_need_desc']		= '<strong>Voraussetzung</strong> — PHP ist die Serverseitige Sprache, in der ultimateXnova geschrieben ist. Damit ultimateXnova ohne Einschränkungen funktioniert, wird die PHP Version 5.2.5 vorrausgesetzt.';
...
$LNG['reg_global_desc']			= 'ultimateXnova wird auch funktionieren, wenn diese Einstellung aktiviert ist. Allerdings wird aus Sicherheitsgründen empfohlen, register_globals in der PHP-Installation zu deaktivieren, falls dies möglich ist.';
$LNG['req_ftp_head']			= 'Eingabe der Zugangsdaten für FTP';
$LNG['req_ftp_desc']			= 'Geben Sie Ihre FTP Daten ein, damit ultimateXnova automatisch die Probleme beheben kann. Alternativ können Sie auch manuell die Schreibrechte vergeben.';
$LNG['req_ftp_host']			= 'Hostname';
$LNG['req_ftp_username']		= 'Benutzername';
$LNG['req_ftp_password']		= 'Kennwort';
$LNG['req_ftp_dir']				= 'Installationspfad zu ultimateXnova';
...
$LNG['step1_desc']				= 'Nachdem nun festgestellt wurde, dass ultimateXnova auf deinem Server betrieben werden kann, musst du noch einige Informationen angeben. Wenn du nicht weißt, wie die Verbindungsdaten für deine Datenbank lauten, kontaktiere bitte als erstes deinen Webhosting-Provider oder wende dich an die ultimateXnova Support-Foren. Wenn du Daten eingibst, prüfe diese bitte sorgfältig, bevor du fortfährst.';
...
$LNG['step3_desc']				= 'Die von ultimateXnova genutzten Datenbank-Tabellen wurden nun erstellt und mit einigen Ausgangswerten gefüllt. Geh weiter zum nächsten Schritt, um die Installation von ultimateXnova abzuschließen.';
...
$LNG['step6_desc']				= 'Du hast ultimateXnova erfolgreich installiert.';
$LNG['step6_info_head']			= 'Starte mit ultimateXnova durch!';
...
$LNG['sql_welcome']				= 'Herzlich Willkommen zu ultimateXnova v';
