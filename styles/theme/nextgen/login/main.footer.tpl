...
<a class="fs-6 m-0 rounded px-2 mb-1 text-white" href="https://github.com/ultimateXnova/ultimateXnova/" title="ultimateXnova" target="copy">ultimateXnova</a>{$VERSION} | Designed by <a href="https://github.com/Pfahli" class="text-white" target="_blank">Pfahli</a>
