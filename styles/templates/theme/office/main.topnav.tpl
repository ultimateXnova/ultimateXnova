...
<div class="planetSelectorWrapper">
	<a href="game.php?page=overview"><img src="{$dpath}planeten/{$image}.jpg" width="30" height="30" alt="{$LNG.lm_overview}"></a>
	...
	<tbody>
		<tr>
			...
			<td id="planetSelectorWrapper">
			   <img src="{$dpath}planeten/{$image}.jpg" width="30" height="30" alt="">
...
<div class="planetImage no-mobile">
   <a href="game.php?page=settings"><img src="{$avatar}" width="50" height="50"></a>
   <div>{$LNG.tech.615}</div>
   <div><b>{$username}</b></div></a>
</div>
